...
--description "(SO0111) AWS Security Hub Automated Response & Remediation ADMINISTRATOR Stack, automated-security-response-on-aws v2.2.0.cnxc.7" \
--template-url "https://sharr-deploy-008012068868-reference.s3.amazonaws.com/automated-security-response-on-aws/v2.2.0.cnxc.7/aws-sharr-deploy.template" \
